 ...
 *
 * Disassembly of DSDT.aml, Fri Mar 31 18:41:03 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001F056 (127062)
 *     Revision         0x02
 *     Checksum         0xD9
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
     ...
     * disassembly, but only 39 were resolved (8 unresolved). Additional
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x7AF48018, 0x06E1)
    ...
    OperationRegion (OGNS, SystemMemory, 0x7AF48FD8, 0x0000000C)
    ...
    OperationRegion (MDBG, SystemMemory, 0x7AF35018, 0x00001004)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0x7AF57018, 0x0200)
