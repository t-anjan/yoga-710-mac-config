 ...
 *
 * Disassembly of SSDT-16.aml, Fri Mar 31 18:41:03 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003AB9 (15033)
 *     Revision         0x01
 *     Checksum         0xBF
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "SSDT", 1, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0x7AEF4018, 0x00040004)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (SGOP, SystemMemory, 0x78F58018, 0x00000046)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (NOPR, SystemMemory, 0x7AEF1018, 0x00002010)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        ...
        {
            Store (Zero, LNKD)
            \_SB.PCI0.RP01.PXSX.SGPO (0x0002000A, One)
            While (LNotEqual (\_SB.PCI0.RP01.PXSX.SGPI (0x80010011), Zero))
            {
                Sleep (One)
            }
            ...
            \_SB.PCI0.RP01.PXSX.SGPO (0x0002000A, Zero)
            Sleep (0x14)
        ...
        {
            If (LEqual (\_SB.PCI0.RP01.PXSX.SGPI (0x80010011), Zero))
            {
                Return (One)
            }
            ElseIf (LEqual (\_SB.PCI0.RP01.PXSX.SGPI (0x80010011), One))
            {
                Return (0x03)
            }
        }
