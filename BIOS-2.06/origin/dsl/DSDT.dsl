 ...
 *
 * Disassembly of DSDT.aml, Tue Feb 13 14:48:09 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001F05C (127068)
 *     Revision         0x02
 *     Checksum         0x15
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
{
    /*
     * iASL Warning: There were 48 external control methods found during
     * disassembly, but only 41 were resolved (7 unresolved). Additional
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x6FF46018, 0x06E1)
    ...
    OperationRegion (OGNS, SystemMemory, 0x6FF46FD8, 0x0000000C)
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            If (LOr (LEqual (RXMS (0x4F), One), LEqual (\_SB.PCI0.LPCB.EC0.WOLS, One))) {}
            Else
            {
    ...
    OperationRegion (MDBG, SystemMemory, 0x6FF33018, 0x00001004)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0x6FF57018, 0x0200)
